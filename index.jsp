...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <div class="fadeIn first">
	 <a href="login.jsp"><img src="D:\project\asuser.png" id="icon" alt="User Icon" width="10px" height="100px"  /></a>
      <img src="D:\project\logo.png" id="icon" alt="User Icon" width="10px" height="100px"  />
	   <a href="adminlogin.jsp"><img src="D:\project\asadmin.png" id="icon" alt="User Icon" width="10px" height="100px"  /></a>
    </div>
    ...
    <form action="ProductController">
	  ...
	  <a href="part1.html" align="right">Register</a>
    </form>
